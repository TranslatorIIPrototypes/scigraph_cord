...
from bigsort import batch_sort
...
def go():
    ...
    call('cat omnicorp_output/annotation_2.txt output/annotation_0.txt | sort -T . | uniq > omnicorp_output/annotation_3.txt', shell=True)
